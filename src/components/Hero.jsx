...
function Hero() {
  ...
  // `sticky top-0` for the ride. offset "start start" -> "end end" maps
  // progress 0->1 across exactly the span the inner content spends
  // pinned to the viewport, so the 3D narrative has room to play out
    ...
    <section ref={heroRef} className="relative h-[300vh] bg-prometeo-red text-white">
      <div className="sticky top-0 h-svh overflow-hidden">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="relative z-10 mx-auto flex h-full max-w-6xl flex-col items-center justify-center gap-8 px-6 py-24 text-center"
        >
